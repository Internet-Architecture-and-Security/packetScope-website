...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className={`max-w-6xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-2xl md:text-3xl text-gray-300 mb-4 font-light tracking-wide">
            Smart Armor for Server-Side Defense
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center gap-3 shadow-2xl hover:shadow-blue-500/25 hover:scale-105 hover:-translate-y-1 cursor-pointer">
              <Play className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              Get Started
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="group border-2 border-gray-600 hover:border-gray-400 px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center gap-3 hover:bg-gray-800/50 backdrop-blur-sm cursor-pointer">
      ...
      <section className="py-32 px-4 bg-gradient-to-b from-gray-800 to-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-purple-300 font-medium">Feature Modules</span>
            </div>
            <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              Comprehensive Network Intelligence
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Four core modules work together to provide comprehensive network protocol stack 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className={`group cursor-pointer p-8 rounded-3xl border-2 transition-all duration-500 ${
                    activeFeature === index 
                      ? 'bg-gray-800 border-purple-500 shadow-2xl shadow-purple-500/20 scale-105' 
                ...
                >
                  <div className="flex items-start gap-6">
                    <div className={`flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r ${feature.color} group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-400 mb-3 font-medium">{feature.subtitle}</p>
                      <p className="text-gray-300 leading-relaxed">{feature.description}</p>
                    </div>
                    <ChevronRight className={`w-6 h-6 text-gray-400 transition-transform duration-300 ${activeFeature === index ? 'rotate-90 text-purple-400' : ''}`} />
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-12 rounded-3xl border border-gray-700 shadow-2xl backdrop-blur-sm">
                <div className="aspect-square flex items-center justify-center relative">
                  <div className={`w-56 h-56 rounded-3xl bg-gradient-to-r ${features[activeFeature].color} flex items-center justify-center transition-all duration-500 hover:scale-110 shadow-2xl relative overflow-hidden`}>
                ...
                <div className="text-center mt-8">
                  <h4 className="text-3xl font-bold text-white mb-2">{features[activeFeature].title}</h4>
                  <p className="text-gray-300 text-lg">{features[activeFeature].subtitle}</p>
                  <div className="mt-4 inline-flex items-center gap-2 bg-gray-700/50 rounded-full px-4 py-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-green-300 text-sm font-medium">Active Module</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-green-300 font-medium">Use Cases</span>
            </div>
            <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
              Enterprise Solutions
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              From DevOps optimization to enterprise security, PacketScope adapts to your needs.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {useCases.map((useCase, index) => (
              <div key={index} className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm p-8 rounded-3xl border border-gray-700 hover:border-green-500/50 transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center justify-center w-14 h-14 bg-gradient-to-r from-green-500 to-blue-500 rounded-2xl group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-green-300">{useCase.title}</h3>
      ...
      <section className="py-32 px-4 bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-green-900/20 relative">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="mt-16 flex flex-col sm:flex-row gap-6 justify-center">
            <button className="group bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 shadow-2xl hover:shadow-blue-500/25 hover:scale-105 hover:-translate-y-1">
              <Download className="w-5 h-5 group-hover:scale-110 transition-transform" />
              Download PacketScope
            </button>
            <button className="group border-2 border-gray-600 hover:border-gray-400 px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 hover:bg-gray-800/50 backdrop-blur-sm">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-2xl font-bold">PacketScope</span>
              </div>
              <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
                Smart armor for server-side defense. Comprehensive protocol stack analysis 
                and debugging tool powered by eBPF and AI.
              </p>
              <div className="flex items-center gap-4">
